...
pub fn run() {
    ...
    // Add explicit type
    let z: i64 = 45454473637;
    // Why I use an underscore below
    /*
        warning: unused variable: `z`
      --> src\types.rs:26:9
       |
    26 |     let z: i64 = 45454473637;
    ...
    */
    ...
    let a1 = 'a'; // use single quotes for a char
    let flying_saucer = '\u{1F6F8}';

    println!("{:?}", (x, y, z, is_active, is_greater, a1, flying_saucer));
}
